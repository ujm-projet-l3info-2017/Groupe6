...
public class AllocineApiTest {
    ...
    private final ApiUrlTest apiUrl;
     ...
     */
    public AllocineApiTest(final String partnerKey, final String secretKey, final HttpClient httpClient) throws AllocineException {
        ...
        this.apiUrl = new ApiUrlTest(partnerKey, secretKey);
